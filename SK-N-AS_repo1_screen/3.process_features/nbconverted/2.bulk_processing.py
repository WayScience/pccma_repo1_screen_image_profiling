...
# produced by 0.convert_cytotable.ipynb. Lives on the external drive (not
# under ./data) since each plate's profile is tens of GB.
...
# Unlike the source pipeline this step was adapted from, SK-N-AS has no
